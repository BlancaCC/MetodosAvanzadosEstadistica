...
Comenzaremos llamnado a las bibliotecas que utilizaremos a lo largo de este ejercicio y cargando los datos relevantes.  
```{R}
library(magrittr)
library(dplyr)
library(purrr)
...
```
esto no da un rango de incertidumbre en el que puede oscilar cada uno de los respectivos parámetros con 
...
si tuvieramos razones para pensar que se da esta condición. 
