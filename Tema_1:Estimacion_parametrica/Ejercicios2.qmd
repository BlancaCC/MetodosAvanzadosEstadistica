...
Si no tenemos en cuenta los estratos y  $p_1 = p_2$ entonces ambos tendrían la misma distribución, 
es decir $X \sim B(n_1, p_1)$ y $Y \sim B(n_2, p_1)$ y por tanto la distribución seguiría una distribución 
